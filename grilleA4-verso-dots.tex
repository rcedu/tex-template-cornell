...
\begin{tikzpicture}[remember picture,overlay,shift=(current page.north west)]
	\begin{scope}[shift={(\MLmarge,-\MLmargehaut)}]
		\draw[
				pattern={Dots[distance=5mm,radius=0.1mm,xshift=1mm,yshift=1mm]},
				pattern color=gray,draw=black]
			(0mm,0) rectangle +(\MLsurfacelargeur,-\MLsurfacehauteur);
	\end{scope}
\end{tikzpicture}
